...
/**
 * Globaler Interaction-Handler, der Slash Commands, Select Menus, Buttons und Modals verarbeitet.
 *
 * @param {Client} client - Der Discord-Client.
 * @param {Interaction} interaction - Die empfangene Interaktion.
    ...
    if (interaction.isCommand()) {
      ...
      if (customId.startsWith('edit_')) {
        try {
          ...
          const oldText = typeof entry?.text === 'string' ? entry.text : '';
