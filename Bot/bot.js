...
/**
 * Lädt Module aus einem Verzeichnis und fügt sie der angegebenen Collection hinzu.
 *
 * @param {string} directory - Das Verzeichnis, in dem sich die Module befinden.
 * @param {Collection|Map} collection - Die Collection, in die die Module geladen werden.
...
/**
 * Registriert Commands entweder global oder für eine spezifische Guild.
 *
 * @param {string|null} guildId - Die Guild-ID oder null für globale Commands.
 * @returns {Promise<void>}
 */
