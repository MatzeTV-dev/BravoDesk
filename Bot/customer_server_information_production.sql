...
-- Dumping database structure for customer_server_information_production
DROP DATABASE IF EXISTS `customer_server_information_production`;
CREATE DATABASE IF NOT EXISTS `customer_server_information_production` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `customer_server_information_production`;

-- Dumping structure for procedure customer_server_information_production.ActivateKey
...
-- Dumping structure for table customer_server_information_production.activation_keys
...
-- Dumping structure for procedure customer_server_information_production.Add_User_To_Blacklist
...
-- Dumping structure for procedure customer_server_information_production.CheckDiscordIDWithKey
...
-- Dumping structure for procedure customer_server_information_production.CheckKeyActivated
...
-- Dumping structure for procedure customer_server_information_production.CheckKeyExists
...
-- Dumping structure for procedure customer_server_information_production.CheckKeyValidity
...
-- Dumping structure for procedure customer_server_information_production.Check_If_Server_Exists
...
-- Dumping structure for procedure customer_server_information_production.Check_User_Blacklisted
...
-- Dumping structure for procedure customer_server_information_production.CreateCategory
...
-- Dumping structure for procedure customer_server_information_production.DeleteCategory
...
-- Dumping structure for procedure customer_server_information_production.Delete_Server_Information
...
-- Dumping structure for procedure customer_server_information_production.GetActivationKey
...
-- Dumping structure for procedure customer_server_information_production.GetCategories
...
-- Dumping structure for procedure customer_server_information_production.Get_Server_Information
...
-- Dumping structure for procedure customer_server_information_production.Remove_User_From_Blacklist
...
-- Dumping structure for procedure customer_server_information_production.Save_Server_Information
...
-- Dumping structure for table customer_server_information_production.server_activations
...
-- Dumping structure for table customer_server_information_production.server_information
...
-- Dumping structure for procedure customer_server_information_production.sp_AddBlacklist
...
-- Dumping structure for procedure customer_server_information_production.sp_AddTicketCategory
...
-- Dumping structure for procedure customer_server_information_production.sp_DeleteTicketCategory
...
-- Dumping structure for procedure customer_server_information_production.sp_GetBlacklist
...
-- Dumping structure for procedure customer_server_information_production.sp_GetTicketCategories
...
-- Dumping structure for procedure customer_server_information_production.sp_RemoveBlacklist
...
-- Dumping structure for procedure customer_server_information_production.sp_SearchBlacklist
...
-- Dumping structure for procedure customer_server_information_production.sp_UpdateTicketCategory
...
-- Dumping structure for table customer_server_information_production.ticket_blacklist
...
-- Dumping structure for table customer_server_information_production.ticket_categories
