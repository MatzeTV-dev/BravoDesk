          ...
          const styles = `
            <style>
              ...
              .fg-emoji-container {
                ...
                background-color: #2a2a2a; /* Dunkler Hintergrund statt weiß */
                overflow: hidden;
                z-index: 9999;
              }
              ...
              .fg-emoji-picker-category-title {
                ...
                border-bottom: 1px solid #444; /* dunklerer Rand */
              }
              
              /* Navigation des Emoji Pickers */
              .fg-emoji-nav {
                background-color: #1e1e1e; /* passt zu deinem Sidebar-Hintergrund */
              }
              ...
              .fg-emoji-nav ul li.emoji-picker-nav-active a {
                background-color: #333; /* dunkler Hover-Hintergrund */
              }
              ...
              /* Spezielle Buttons (z.B. Sonderaktionen) */
              ...
              .fg-emoji-list li a:hover {
                background-color: #333; /* dunklerer Hover-Hintergrund */
              }
